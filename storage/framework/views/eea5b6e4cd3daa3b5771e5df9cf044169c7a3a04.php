<?php $__env->startSection('title', 'Freshshop - Products Shop'); ?>
                    ...
                    <div class="right-product-box">
                        <div class="product-item-filter row">
                            <div class="col-12 col-sm-8 text-center text-sm-left">
                                ...
                                <p>Showing all <?php echo e($products->count()); ?> results</p>
                            </div>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                    <div class="row">
                                        ...
                                        <?php $__currentLoopData = $all_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                <div class="products-single fix">
                                                    <div class="box-img-hover">
                                                        ...
                                                        <img src="<?php echo e(url('/fresh/images/'.$image->image_name)); ?>" class="img-fluid" alt="Image">
                                                        <div class="mask-icon">
                                                        <a class="cart" href="/products/<?php echo e($image->product->id); ?>">View Product</a>
                                                        </div>
                                                    </div>
                                                    <div class="why-text">
                                                        <h4><?php echo e($image->product->product_name); ?></h4>
                                                        <h5>Rp. <?php echo e($image->product->price); ?>/kg</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    <h4><?php echo e($image->product->product_name); ?></h4>
                                                    <h5> <del>Rp 100000</del>Rp. <?php echo e($image->product->price); ?>/kg</h5>
                                                    <p><?php echo e($image->product->description); ?></p>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\prognet13\resources\views/products/shop.blade.php ENDPATH**/ ?>