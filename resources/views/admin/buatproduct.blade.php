        ...
        <li class="nav-item active">
          ...
          <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item active" href="{{ url('/buatproduct') }}">Create Product</a>
            </div>
          </div>
        </li>
                  ...
                  @if (session('status'))
                    ...
                    <div class="form-row ">
                      <div class="col">
                        ...
                        <input type="text" class="form-control @error('product_name') is-invalid @enderror" id="nama" placeholder="Ex: Apel" name="product_name" value="{{ old('product_name') }}">
                        @error('product_name')<div class="invalid-feedback"> {{ $message }}</div> @enderror
                      </div>
                      <div class="col">
                        <label for="harga">Harga Product</label>
                        <input type="text" class="form-control @error('price') is-invalid @enderror" id="harga" placeholder="Ex: 10000" name="price" value="{{ old('price') }}">
                    ...
                    <div class="form-row ">
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('description') is-invalid @enderror" id="deskripsi" placeholder="Ex: Enak Banget" name="description" value="{{ old('description') }}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('weight') is-invalid @enderror" id="berat" placeholder="Ex: 1kg " name="weight" value="{{ old('weight') }}">
                        ...
                        <div class="col">
                            <div class="form-group">
								                <label for="kategori">Kategori</label>
								                     <select class="form-control @error('category') is-invalid @enderror" id="kategori" placeholder="Nothing " name="category" value="{{ old('category') }}">
