...
MySQL - 10.1.38-MariaDB : Database - db_praktikum_prognet
*********************************************************************
*/
...
insert  into `admins`(`id`,`first_name`,`last_name`,`username`,`password`,`profile_image`,`email`,`phone`,`remember_token`,`created_at`,`updated_at`) values 
(1,'Maulidy','Adi','maul123','123456','','maul@gmail.com','123456',NULL,NULL,NULL);
...
(1,'JNE',NULL,NULL),
(2,'Pos Indonesia',NULL,NULL),
(3,'Go-Send',NULL,NULL),
(4,'J&T Express',NULL,NULL);
...
(1,'Hard Fruits',NULL,NULL),
(2,'Soft Fruits',NULL,NULL),
(3,'Tropical Fruits',NULL,NULL),
(4,'Citrus Fruits',NULL,NULL),
(5,'Miscellaneous Fruits',NULL,NULL),
(6,'Vegetables','2020-04-25 08:14:01','2020-04-25 08:14:01'),
(11,'Seasoning','2020-04-25 09:49:25','2020-04-25 10:38:18');
...
(1,1,1,'2020-04-26 08:37:03','2020-04-26 08:37:03'),
(2,2,1,'2020-04-26 08:37:20','2020-04-26 08:37:20'),
(3,3,1,'2020-04-26 08:37:33','2020-04-26 08:37:33');
...
(1,1,'fresh/images/apel-merah.jpg',NULL,NULL),
(2,2,'fresh/images/pir-bartlett.jpg',NULL,NULL),
(3,3,'fresh/images/pir-anjou.jpg',NULL,NULL);
...
(1,1,1,9,'Mantap! Enak! Gas Beli! Borong! Jangan sampai kehabisan!',NULL,NULL),
(2,2,1,10,'Enak banget! Suka saya sama pir! Langsung kasi 10 deh buat pir.',NULL,NULL),
(3,3,1,10,'Enak Gan! Kasi 10 dulu, kalau pas setiap dikunyah makin enak saya kasi 100!',NULL,NULL);
...
(1,'Apel Merah',20000,'Apel Segar Langsung dipetik dari pohonnya',9,NULL,NULL,100,1),
(2,'Pir Bartlett',30000,'Pir Bartlett Segar Sekali. Rasanya enak dijamin bikin ketagihan',10,NULL,NULL,100,1),
(3,'Pir Anjou',40000,'Pir Anjou Mantap. Enak dan lembut sekali. Borong Yuks! Hayuuuuk! Meluncur!',10,NULL,NULL,100,1);
...
insert  into `users`(`id`,`first_name`,`last_name`,`username`,`email`,`birthday`,`phone`,`profile_image`,`status`,`email_verified_at`,`password`,`remember_token`,`created_at`,`updated_at`) values 
(1,'Fiqri','Nurahman Yasir','fiqri098','fiqri098@gmail.com','2000-01-17','123456789','','',NULL,'123456',NULL,NULL,NULL);
